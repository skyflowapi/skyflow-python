...
# (referenced in a Skyflow policy as request.context).
...
# Each key maps to a Skyflow CEL policy variable under request.context.*, for example:
#   request.context.role == "admin" and request.context.department == "finance"
...
# Approach 3: Bearer token with string context from a credentials string.
