...
class SkyflowErrorMessages(Enum):
    ...
    INVALID_TABLE_TYPE_DELETE = "Table of type string is required in records array"
    INVALID_IDS_TYPE = "Ids key has value of type %s, expected list"
    INVALID_ID_TYPE = "Id key has value of type %s, expected string"
    INVALID_ID_TYPE_DELETE = "Id of type string is required at index 0 in records array"
