...
class TokenType(UniversalBaseModel):
    """
    Mapping of tokens to generation for detected entities. Can't be specified together with `token_type`.
    """

    default: typing.Optional[TokenTypeDefault] = None
    vault_token: typing.Optional[typing.List[EntityType]] = pydantic.Field(default=None)
    """
