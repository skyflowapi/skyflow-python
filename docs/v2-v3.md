...
| **Node.js** | Installation: `npm install skyflow-node`<br>Import: `import { Skyflow } from 'skyflow-node';` | Installation: `npm install skyflow-node@3.0.0`<br>Import: `import { Skyflow } from 'skyflow-node';` | Installation: `npm install skyflow-flowdb-node@1.0.0`<br>Import: `import { Skyflow } from 'skyflow-flowdb-node';` |
